...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pageluxe Issue Builder generates interactive magazine layouts for print and digital publication." },
      { name: "author", content: "Pageluxe" },
      { property: "og:title", content: "Pageluxe Issue Builder" },
      { property: "og:description", content: "Pageluxe Issue Builder generates interactive magazine layouts for print and digital publication." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Nunito+Sans:opsz,wght@6..12,300;6..12,400;6..12,600;6..12,700;6..12,800;6..12,900&family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400&family=Cinzel:wght@400;500;600;700&family=Italiana&display=swap",
      },
    ],
  }),
